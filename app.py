...
st.write("Enter a topic or question and get answers from ChatGPT, DuckDuckGo, and Wikipedia!")
...
if st.button("Search") and query.strip():
    ...
    if st.button("Save Selected Result"):
        ...
        elif save_choice == "DuckDuckGo":
            save_msg = save_tool.run(duck_result)
